  ...
  inquirer
    .prompt([
      ...
      }, // prompt to ask user for the text color
      {
        name: "logoColor",
        message:
          "TEXT COLOR: Enter the color keyword (OR a hexadecimal number):",
      },
      {
        //prompt to ask user for shape they want
        name: "shape",
        message: "SHAPE: Choose from the three shapes below.",
        type: "list",
      ...
      },
      {
        ...
        name: "shapeColor",
        message:
          "SHAPE COLOR: Enter the color keyword (OR a hexadecimal number):",
      },
    ])
    .then((userInput) => {
